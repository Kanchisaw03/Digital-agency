...
export default function Contact() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50 dark:bg-dark py-10 px-2">
      <div className="max-w-5xl w-full bg-white dark:bg-dark rounded-2xl shadow-xl mx-auto flex flex-col md:flex-row items-center gap-10 p-6 md:p-12">
        {/* Left: Logo/Graphic */}
        <div className="flex-1 flex flex-col items-center justify-center mb-8 md:mb-0">
          ...
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-300 text-center hidden md:block">Let's Talk</p>
        </div>
        {/* Right: Form */}
